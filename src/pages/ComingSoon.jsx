    ...
    >
      <div className="mx-auto px-4 md:px-5 lg:px-5 w-full max-w-7xl">
        <div className="flex flex-col justify-end items-center gap-10 md:gap-16 lg:gap-28 bg-black/75 px-10 md:px-16 pt-10 md:pt-16 pb-10 rounded-2xl w-full">
          <div className="flex flex-col justify-end items-center">
            ...
            <div className="flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-10">
              <div className="flex flex-col justify-start items-center gap-2.5">
                ...
                <p className="text-base text-center text-gray-200 leading-relaxed">
              ...
              <div className="flex flex-col justify-center items-center gap-5 w-full">
                ...
                <div className="flex sm:flex-row flex-col justify-center items-center gap-2.5">
                  <input
                    type="text"
                    className="w-80 focus:outline-none border-gray-200 bg-white shadow-sm px-3.5 py-2 border rounded-lg h-10 text-gray-900 text-sm leading-relaxed placeholder-gray-400"
          ...
          <p className="text-center text-gray-200 text-sm leading-snug">

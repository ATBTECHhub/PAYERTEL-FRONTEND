          ...
          <div className="lg:py-16 lg:w-[35%] mx-auto lg:space-y-14 container space-y-7 py-14">
            <div className="grid lg:space-y-4 space-y-2">
              ...
              <input
                ...
                type="number"
                placeholder="023657487654"
              />
              <i className="text-white absolute xl:pl-[450px] lg:pt-9 pl-64 pt-7 md:pl-[650px] lg:pl-72">
                <IoIosCheckmark className="w-4 h-4 border-1 rounded-full bg-green-500" />
              </i>
            </div>
            <div className="grid lg:space-y-4 space-y-2">
              <label

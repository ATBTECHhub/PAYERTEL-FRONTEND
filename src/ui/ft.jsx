const Footer4 = () => {
  return (
    <footer className="relative z-10 bg-[#090E34] pt-20 lg:pt-[120px] overflow-hidden">
      <div className="mx-auto container">
        <div className="flex flex-wrap -mx-4">
          <div className="px-4 w-full sm:w-2/3 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <a href="/#" className="inline-block mb-6 max-w-[160px]">
                <img
          ...
          <div className="px-4 w-full md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 font-semibold text-lg text-white">
                Latest blog
              </h4>
              <a
                href="javascript:void(0)"
                className="flex items-center mb-8 text-gray-7 hover:text-white"
              >
                <div className="mr-5 rounded w-full max-w-[70px] overflow-hidden">
                  <img
      ...
      <div className="border-[#8890A46E] mt-12 lg:mt-[60px] py-8 border-t">
        <div className="mx-auto container">
          <div className="flex flex-wrap -mx-4">
            <div className="px-4 w-full md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="flex flex-wrap justify-center md:justify-start items-center -mx-3">
            ...
            <div className="px-4 w-full md:w-1/3 lg:w-1/2">
      ...
      <div>
        <span className="top-0 left-0 z-[-1] absolute">
          <svg
            width="419"
            height="492"
            viewBox="0 0 419 492"
        ...
        <span className="right-0 bottom-0 z-[-1] absolute">
          <svg
            width="327"
            height="220"
            viewBox="0 0 327 220"
        ...
        <span className="top-0 right-0 z-[-1] absolute">
          <svg
            width="102"
            height="102"
            viewBox="0 0 102 102"
...
const LinkGroup = ({ children, header }) => {
  return (
    <div className="px-4 w-full sm:w-1/2 lg:w-3/12 xl:w-2/12">
      <div className="mb-10 w-full">
...
const NavLink = ({ label, link }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-base text-gray-7 hover:text-white underline-offset-2 hover:underline leading-loose"
      >
        {label}
      </a>
    </li>
...
const BottomNavLink = ({ label, link }) => {
  return (
    <a
      href={link}
      className="px-3 text-base text-gray-7 hover:text-white underline-offset-2 hover:underline"
    >
      {label}
    </a>
  );

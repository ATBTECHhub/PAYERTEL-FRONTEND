        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="gap-4 sm:gap-6 lg:gap-8 grid grid-cols-2 md:grid-cols-4">
            <div className="flex flex-col justify-center items-center gap-4 px-4 self-center">
              ...
              <div className="flex items-center">
                <a
                  href="/"
                  target="_blank"
                  className="px-2 sm:px-3 text-white hover:text-gray-300"
                >
                  <svg
                    width="10"
                    height="18"
            ...
            <LinkGroup header="Useful Links">
              <LinkItem link="home" label="Home" />
              <LinkItem link="about" label="About" />
              <LinkItem link="how-it-works" label="How It Works" />
              <LinkItem link="testimonials" label="Testimonials" />
              <LinkItem link="contact" label="Contacts" />
            </LinkGroup>
          ...
          <div className="border-[#8890A46E] py-2 sm:py-4 border-t">
              ...
              <div className="p-4">
                <div className="my-1">
                  <div className="flex flex-wrap justify-center md:justify-start items-center gap-4">
                    ...
                    <BottomNavLink link="/#" label="Status" />
                    <p className="text-base text-white">
                      &copy; {new Date().getFullYear()} Payertel
                    </p>
                  </div>
                </div>
              </div>
  ...
  return (
    <li>
      <Link
        ...
        duration={500}
        to={link}
        className="inline-block text-base text-white hover:text-white underline-offset-2 hover:underline leading-loose"
      >
        {label}
      </Link>
    </li>

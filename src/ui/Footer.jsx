        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="gap-8 grid grid-cols-2 md:grid-cols-4">
            ...
            <LinkGroup header="Useful Links">
              ...
              <NavLink link="" label="Contacts" />
            </LinkGroup>

            <LinkGroup header="Services">
              <NavLink link="/#" label="Airtime" />
              <NavLink link="/#" label="Data Bundle" />
              <NavLink link="/#" label="Cable Tv" />
              <NavLink link="/#" label="Airtime to Cash" />
            </LinkGroup>
            <a
          ...
          <div className="border-[#8890A46E] mt-12 lg:mt-[60px] py-8 border-t">
            <div className="flex flex-wrap justify-center items-center -mx-4">
              ...
              <div className="flex justify-self-end items-center lg:ml-auto py-4">

        ...
        >
          ...
          <div className="flex flex-col justify-self-start gap-10 lg:mb-0 pb-4">
            ...
            <p className="font-normal text-xl">
              ...
              purchases, airtime top-ups, airtime to cash consersions, and cable
              network subscriptions. The platform aims to provide these services
              at competitive rates while ensuring a seamless user experience.
            </p>
          </div>
        </div>
      </div>
